...
,
  {
    path: '/design-system/organisms/balancecardgroup',
    name: 'organisms-BalanceCardGroup',
    component: () => import('@/generated/pages/organisms/BalanceCardGroupPage.vue'),
    meta: {"title":"BalanceCardGroup","section":"Organisms"}
  }
]
